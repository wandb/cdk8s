...
export const isExternalRedis = (config: RedisCredentialsConfig): boolean => {
  return config.host !== 'redis-service'
}
...
export const canConnectToRedis = (
  ...
  if (config.password != null) command.push('-a', '$(REDIS_PASSWORD)')
